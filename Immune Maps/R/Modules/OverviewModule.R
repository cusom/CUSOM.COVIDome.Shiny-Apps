            ...
            box(
              ...
              HTML(
                ...
                <div style="margin-left: 15px;">
                  <span class="fas fa-virus"></span><b> Effect of COVID-19 status</b>: Explore the differences by &lsquo;parent cell lineage&rsquo; between samples from those with versus without COVID-19. 
                  <br />
                  <span class="fas fa-shield-virus"></span><b> Effect of Seroconversion</b>: Explore the differences by &lsquo;parent cell lineage&rsquo; between samples from COVID-19 patients with low levels of seroconversion versus those with high levels of seroconversion.  
                  <br />
                  <span class="fas fa-viruses"></span><b> Cross Omics Correlates</b>: Investigate correlations between any immune cell type of choice and any other feature present in the other datasets.
                </div>
                <br />
